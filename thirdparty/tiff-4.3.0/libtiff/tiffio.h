...
int TIFFRGBAImageGet_64(TIFFRGBAImage *img, uint64_t *raster, uint32_t w, uint32_t h);
int TIFFReadRGBAStrip_64(TIFF *tif, uint32_t row, uint64_t *raster);
int TIFFReadRGBAStripExt_64(TIFF *tif, uint32_t row, uint64_t *raster, int stop_on_error);
int TIFFReadRGBATile_64(TIFF *tif, uint32_t x, uint32_t y, uint64_t *raster);
int TIFFReadRGBATileExt_64(TIFF *tif, uint32_t col, uint32_t row, uint64_t *raster, int stop_on_error);
